...
public class DeliveryDto {
    ...
    public DeliveryDto(int deliveryId, int orderId, String detailsLocation) {
    ...
    public void setDetailsLocation(String detailsLocation) { this.detailsLocation = detailsLocation; }
