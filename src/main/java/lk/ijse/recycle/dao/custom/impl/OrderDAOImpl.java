...
public class OrderDAOImpl implements OrderDAO {
    ...
    public boolean save(Order dto) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            ResultSet rs = CrudUtil.execute("SELECT stock_quantity FROM product WHERE product_id = ? FOR UPDATE",
                    dto.getProductId());
            ...
            boolean saved = CrudUtil.execute(
                    "INSERT INTO orders(product_id, customer_id, quantity, total_price, order_date) VALUES (?, ?, ?, ?, ?)",
                    dto.getProductId(),
                    dto.getCustomerId(),
                    dto.getQuantity(),
                    dto.getTotalPrice(),
            ...
            boolean reduced = CrudUtil.execute(
    ...
    public boolean update(Order dto) throws SQLException, ClassNotFoundException {
        return CrudUtil.execute(
                "UPDATE orders SET product_id = ?, customer_id = ?, quantity = ?, total_price = ?, order_date = ? WHERE order_id = ?",
                dto.getProductId(),
                dto.getCustomerId(),
                dto.getQuantity(),
                dto.getTotalPrice(),
